...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow-sm border-0 h-100">
                <div class="card-header bg-light py-3 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold text-success"><i class="fa-solid fa-arrow-down-long me-2"></i>Aktivitas Barang Masuk</h5>
                            ...
                            <tbody>
                                @forelse($incomingGoods as $in)
                                    <tr>
                                        ...
                                        <td>{{ $in->transaction_date ? $in->transaction_date->format('d/m/Y') : '-' }}</td>
                                        <td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center text-muted py-3">Tidak ada riwayat barang masuk periode ini.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
        ...
        <div class="col-lg-6 mb-4">
            <div class="card shadow-sm border-0 h-100">
                <div class="card-header bg-light py-3 d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 fw-bold text-danger"><i class="fa-solid fa-arrow-up-long me-2"></i>Aktivitas Barang Keluar</h5>
                            ...
                            <tbody>
                                @forelse($outgoingGoods as $out)
                                    <tr>
                                        ...
                                        <td>{{ $out->purpose }}</td>
                                        <td>{{ $out->transaction_date ? $out->transaction_date->format('d/m/Y') : '-' }}</td>
                                        <td>
                                            <span class="badge bg-secondary">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center text-muted py-3">Tidak ada riwayat barang keluar periode ini.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
