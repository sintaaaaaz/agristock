            ...
            <div class="card-body p-4">
                ...
                <form action="{{ route('incoming-goods.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control bg-light border-0 py-2 text-capitalize"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="transaction_date"
                            class="form-control @error('transaction_date') is-invalid @enderror py-2"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="product_name"
                            class="form-control @error('product_name') is-invalid @enderror py-2"
                            placeholder="Contoh: Padi IR64, Jagung Manis" value="{{ old('product_name') }}" required>
                        @error('product_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="quantity"
                                class="form-control @error('quantity') is-invalid @enderror py-2" min="1"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="purchase_price"
                                class="form-control @error('purchase_price') is-invalid @enderror py-2"
                                placeholder="Masukkan harga beli" value="{{ old('purchase_price') }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" name="image" class="form-control @error('image') is-invalid @enderror py-2"
                            accept="uploads/product/*">
