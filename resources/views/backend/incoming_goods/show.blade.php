            ...
            <div class="card shadow-sm border-0 rounded-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <span class="fw-semibold">{{ \Carbon\Carbon::parse($incomingGood->transaction_date)->format('d F Y') }}</span>
                    </div>
                    <div class="mb-3">
                        <small class="text-muted d-block">Nama Supplier Pemasok</small>
                        <span class="fw-bold text-dark">{{ $incomingGood->supplier->supplier_name ?? 'Pemasok Mandiri Aplikasi' }}</span>
                    </div>
                    <div class="mb-0">
        ...
        <div class="col-md-8 mb-4">
            <div class="card shadow-sm border-0 rounded-3">
                <div class="card-header bg-white py-3 border-0">
                    <h5 class="mb-0 fw-bold text-dark"><i class="fa-solid fa-boxes-stacked me-2 text-success"></i> Rincian Item Komoditas Masuk</h5>
                </div>
