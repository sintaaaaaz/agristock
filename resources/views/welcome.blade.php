...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light sticky-top py-3"
        style="background-color: #f8f9fa; border-bottom: 1px solid #ebebeb;">
        <div class="container">
        ...
        <div class="container text-center text-lg-start">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    <span
                        class="badge bg-light text-success fw-bold px-3 py-2 rounded-pill uppercase tracking-wider mb-3">
                    ...
                    <p class="lead text-white-50 mb-4 fs-5">
                        AgriStock membantu para kelompok tani dan administrator gudang memantau pencatatan komoditas
                        barang masuk, inventaris stok, hingga alur distribusi keluar secara real-time.
                    </p>
                    <div class="d-flex flex-column flex-sm-row gap-3 justify-content-center justify-content-lg-start">
                        <a href="{{ route('login') }}"
                            class="btn btn-light btn-lg text-success fw-bold px-5 py-3 rounded-3 shadow">
                            Mulai Sekarang
                        </a>
            ...
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="card p-4 border-0 shadow-sm rounded-3 h-100">
                        ...
                        <p class="text-muted small mb-0">Petani atau operator dapat langsung menginput data komoditas
                            pasca-panen langsung ke sistem utama.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card p-4 border-0 shadow-sm rounded-3 h-100">
                        ...
                        <p class="text-muted small mb-0">Visualisasi data analisis pasokan masuk dan keluar tahunan yang
                            memudahkan estimasi pasar bagi Admin.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card p-4 border-0 shadow-sm rounded-3 h-100">
                        ...
                        <p class="text-muted small mb-0">Sistem otomatis memotong saldo kuantitas barang di gudang utama
                            setiap ada transaksi pengeluaran logistik.</p>
                    </div>
                </div>
            </div>
        </div>
